import antlr4
from .parser import sa_cpp14
class ExampleErrorListener(sa_cpp14.SA_ErrorListener):
    def syntaxError(self, input_stream, offendingSymbol,
        ...
        print("    column:", column)
        print("    msg:", msg)
def build_tree(input_file: str):
    if sa_cpp14.USE_CPP_IMPLEMENTATION:
    ...
    tree = sa_cpp14.parse(stream, "translationUnit", sa_err_listener)
    return tree